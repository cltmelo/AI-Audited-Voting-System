...
2. Clone o repositório:
        ...
        git clone https://github.com/cltmelo/AI-Audited-Voting-System.git
...
3. **IMPORTANTE:** Excute os seguinte comandos na raíz do projeto para limpar todo cache local e excluir dados e credenciais antigos que farão o projeto não funionar.
        ...
        rm -f data/audit_database.json       # Apaga os dados antigos de enriquecimento da LLM
        rm report.txt                        # Apaga reports os antigos presentes
